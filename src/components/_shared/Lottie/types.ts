import React, { AnimationEventHandler, MutableRefObject, ReactElement, RefObject } from 'react';
import {
...
export type LottieOptions = Omit<AnimationConfigWithData<any>, 'container'> & {
	lottieRef?: LottieRef;
